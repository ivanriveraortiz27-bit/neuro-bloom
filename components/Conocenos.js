            ...
            <div className="grid md:grid-cols-2 gap-10 lg:gap-16 items-stretch">
                ...
                <div className="bg-white/80 backdrop-blur-xl p-8 lg:p-12 rounded-[3rem] shadow-glass border border-white flex flex-col items-center text-center transform transition-all hover:-translate-y-2 hover:shadow-xl group">
                    <div className="w-48 h-48 mb-8 rounded-full overflow-hidden border-4 border-white shadow-lg group-hover:scale-105 transition-transform duration-500 bg-stone-100 flex items-center justify-center">
                        <Thumbnail 
                            src="./rodrigo_ortiz.jpg" 
                            alt="Rodrigo Ortiz" 
                            className="w-full h-full object-cover"
                            fallback={<div className="w-full h-full bg-brand-green/20 flex items-center justify-center text-brand-green"><Activity size={64}/></div>}
                        />
                    </div>
                    ...
                    <p className="text-stone-600 font-light leading-relaxed mb-8 flex-grow">
                        Ingeniero en Mecatrónica radicado en Aguascalientes, responsable de la arquitectura digital de Neuro Bloom. Especializado en el desarrollo de aplicaciones web ágiles y sistemas modulares utilizando tecnologías como React y Firebase. Su perfil combina una mente altamente analítica con una profunda creatividad, dividiendo su tiempo entre la creación de código limpio, la impresión 3D y su pasión como guitarrista y compositor musical.
                    </p>
