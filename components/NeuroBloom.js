            ...
            <footer className="py-16 mt-12 bg-stone-900/95 backdrop-blur-md text-stone-400 flex flex-col items-center justify-center text-center relative z-10">
                ...
                <div className="flex gap-4 mb-6 relative z-20">
                    <a 
                        ...
                        className="p-3 rounded-full bg-white/5 border border-white/10 hover:bg-brand-purple hover:text-white hover:border-brand-purple transition-all duration-300 transform hover:-translate-y-1 shadow-sm"
